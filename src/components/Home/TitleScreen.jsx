...
function TitleScreen() {
  ...
  return (
    <main className="flex h-screen select-none flex-col items-center justify-center bg-black">
      ...
      />
      <button
        className="font-pretendard transform rounded-full bg-punch-red px-4 py-2 text-2xl font-bold text-punch-white shadow-lg transition duration-300 ease-in-out hover:scale-105 hover:bg-punch-dark-red lg:px-6 lg:py-4 lg:text-4xl"
